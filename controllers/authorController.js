...
exports.author_list = (req, res) => {
  Author.find({}, "id first_name family_name date_of_death date_of_birth")
    .sort({ family_name: 1 })
    .exec(function (err, author_books) {
      if (err) {
        return next(err);
      }
      //Successful, so render
      res.render("catalog/author_list", { title: "Author List", author_list: author_books });
    });
};
