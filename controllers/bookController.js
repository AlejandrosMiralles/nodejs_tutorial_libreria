  ...
  async.parallel(
    ...
    (err, results) => {
      ...
      res.render("catalog/book_delete", {
        title: "Delete Book",
        book: results.book,
        books_booksInstances: results.books_booksInstances,
      });
    }
  );
};
...
exports.book_delete_post = (req, res) => {
  async.parallel(
    ...
    (err, results) => {
      ...
      if (results.books_booksInstances.length > 0) {
      ...
      // Book has no booksInstances. It can be deleted
